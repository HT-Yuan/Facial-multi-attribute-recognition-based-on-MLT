...
from efficientnet.model_hard_new_utk_II import EfficientNet
from matrix import plot_heatmap,map_age_values,age_sub
import os
...
def test_model(model, criterion):
    ...
    # plot_heatmap(outPre_age,outLabel_age,outPre_gender,outLabel_gender,outPre_race,outLabel_race,"hard_age",0)
    print('Loss_gender: {:.4f}  Acc_gender: {:.4f} '.format(running_loss_gender/dset_sizes,
        running_corrects_gender.double() / dset_sizes))
...
if __name__ == "__main__":
    ...
    # #年龄
    # # print(num_ftrs)
    # model_ft._fc = nn.Linear(num_ftrs,116)  # age
