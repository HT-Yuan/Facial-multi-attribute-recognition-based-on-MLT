...
## 增加一层Efficient For Hard Adience
import torch
...
from efficientnet.e_adience_without_order import EfficientNet
...
def train_model(model_ft, criterion, optimizer, lr_scheduler, num_epochs=50, a = 0.1):
    ...
    for epoch in range(num_epochs):
        ...
        for data in dset_loaders['train']:
            ...
            # 消融实验
            loss_age = criterion(output_age, label_age)*a
...
def test_model(model, criterion,a=0.1):
    ...
    print('Loss_age: {:.4f}  Loss_gender: {:.4f} Acc_age: {:.4f} Acc_gender: {:.4f} mseloss_age: {:.4f} maeloss_age: {:.4f}'.format(running_loss_age/dset_sizes,running_loss_gender/dset_sizes,
                                            running_corrects_age.double() / dset_sizes,running_corrects_gender.double() / dset_sizes, mseloss_age /dset_sizes,maeloss_age /dset_sizes))
    

    # plot_matrix(outLabel_age,outPre_age,[0,1,2,3,4,5,6,7], ["0-2","4-6","8-12","15-20","25-32","38-43","48-53","60-100"],"hard")
    # plot_matrix(outLabel_age,outPre_age,[1,2,3,4,5,6,7],outLabel_gender,1, ["4-6","8-12","15-20","25-32","38-43","48-53","60-100"],"hard_girl")
    plot_matrix(outLabel_age,outPre_age,[1,2,3,4,5,6,7],outLabel_gender,2, ["4-6","8-12","15-20","25-32","38-43","48-53","60-100"],"hard_boy")
    # p\r\f\总数
