...
from efficientnet.order_utk import EfficientNet
import os
from torch.utils.data import Dataset
from PIL import Image
from matrix import map_age_values,age_sub
...
def test_model(model, criterion):
    ...
    for data in dset_loaders['test']:
        ...
        # 准确度
        # preds_age_low =  preds_age >= (label_age.data - 5)
        # preds_age_high =  preds_age <= (label_age.data + 5)
